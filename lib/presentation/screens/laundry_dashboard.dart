...
import 'package:laundry_middle_transportation/repository/laundry_store.dart';
...
class _HomeState extends State<Home> {
  final LaundryStoreApi laundryStoreApi = LaundryStoreApi();
  ...
  _loadLaundryStoreId() async {
    await laundryStoreApi.getLaundryStoreId();
  }
